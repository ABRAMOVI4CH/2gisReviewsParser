...
class Parser {
    ...
    mapReview(review) {
        ...
        const name = (0, helpers_1.pickFirstNonEmpty)(user?.name ?? null, user?.first_name ? `${user.first_name}${user.last_name ? ` ${user.last_name}` : ''}` : null);
        const iconHref = (0, helpers_1.pickFirstNonEmpty)(photo?.url, photo?.['64x64'], photo?.['320x'], photo?.['640x'], photo?.['1920x']);
        let answer = null;
        ...
        return (0, storage_1.createReview)({
            ...
            date: review.date_created ? (0, helpers_1.formDate)(review.date_created) : null,
